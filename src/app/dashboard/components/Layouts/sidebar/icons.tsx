...
export function Settings(props: PropsType) {
  return (
    ...
    >
      ...
      <path
        d="M12 1v6m0 6v6m11-7h-6m-6 0H1m15.5-3.5L19 10l-1.5-1.5M6.5 14.5L5 16l1.5 1.5M16.5 6.5L18 5l-1.5-1.5M7.5 17.5L6 19l1.5 1.5"
        stroke="currentColor"
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function Code(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
